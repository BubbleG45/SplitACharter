...
<div class="stats-grid">
	...
	<div class="stat-card glass glass-interactive">
		<div class="icon-wrapper" style="background: rgba(14, 165, 233, 0.15); color: #0ea5e9;">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
				<path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
			</svg>
		</div>
		<div class="stat-content">
			<span class="stat-label">Reports & Analytics</span>
			<span class="stat-val" style="font-size: 1.15rem; font-weight: 600;">Explore</span>
		</div>
		<a href="/admin/reports" class="card-link" aria-label="View Admin Reports"></a>
	</div>
</div>
...
<div class="welcome-panel glass glow-primary" style="margin-bottom: 2.5rem;">
	<div class="welcome-content">
		...
		<p>Manage listing templates, oversee matching status, assign captains, review sales performance, and monitor operational analytics.</p>
		<div class="action-buttons">
			<a href="/admin/listings/new" class="btn btn-primary">Create Listing Template</a>
			<a href="/admin/reports" class="btn btn-secondary">Admin Reports</a>
