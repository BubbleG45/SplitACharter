<script lang="ts">
	...
	/* svelte-ignore state_referenced_locally */
	let maxPassengers = $state<number | ''>(data.listing.max_passengers || '');
	/* svelte-ignore state_referenced_locally */
	let customMaxGroupSize = $state<number | ''>(data.listing.max_group_size || '');
...
<svelte:head>
	<title>Edit Listing Template — {data.listing.trip_type}</title>
</svelte:head>

<div class="page-header">
	<div>
		<span class="subtitle">Operations</span>
		<h1>Edit Listing Template</h1>
	</div>
		...
		<div class="form-grid">
			...
			<div class="form-group full-width">
				...
				<input
					...
					id="meeting_area"
					name="meeting_area"
					value={data.listing.meeting_area}
			...
			<div class="form-group full-width checkbox-group">
				<label class="switch-container">
					<input type="checkbox" name="active" value="true" checked={data.listing.active} />
